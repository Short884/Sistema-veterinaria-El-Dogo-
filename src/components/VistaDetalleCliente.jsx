...
function VistaDetalleCliente() {
    ...
    // El backend nombra la relación 'clientesId' (no 'clienteId')
    const mascotasDelCliente = mascotas.filter(m => m.clientesId === clienteId);
                            ...
                            <li key={mascota.id}>
                                ** {mascota.nombre} ** - Especie: {mascota.especie}
                                {mascota.historiaClinica && (
                                    <p>Historia clínica: {mascota.historiaClinica}</p>
                                )}
                            </li>
                        ))}
                    </ul>
